...
rbac_exceptions = Counter("hsp_rbac_exceptions", "count of exceptions raised by rbac service")
inventory_requests = Histogram("hsp_inventory_service_requests", "inventory service call stats")
...
inventory_no_sysprofile = Histogram(
    "drift_systems_compared_no_sysprofile_UNUSED",
    "unused metric - do not use",
)

baseline_service_requests = Histogram("baselines_service_requests", "baseline service call stats")

...
mkdir -p $HOME/.config/bonfire
curl -o $HOME/.config/bonfire/config.yaml https://raw.githubusercontent.com/RedHatInsights/drift-dev-setup/master/clowder/pr_check_bonfire_config.yaml

...
BASELINE_DB_NAME=testdb prometheus_multiproc_dir=$TEMPDIR nosetests -sx --with-coverage --cover-package system_baseline  --cover-min-percentage 84 --cover-erase && rm -rf $TEMPDIR
